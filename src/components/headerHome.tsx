...
import drwer_2 from '@/assets/icon/drawer_2.png';   
const HeaderHome = ({location,navigation}: any): React.JSX.Element => {
    ...
    return (
        <View style={styles.main }>
                          <TouchableOpacity onPress={()=> navigation.openDrawer()}>
                                <Image source={drwer_2} alt="icon" style={{height: 40, width: 40, resizeMode: 'contain'}} />
                            </TouchableOpacity>
                            <Text style={{color:'#250959',fontSize:14,fontWeight:'bold',textTransform:'capitalize'}}>{location}</Text>
                            <View style={{flexDirection:'row',gap:10}}>
                                  <TouchableOpacity onPress={() => { navigate('SearchTab'); }}>
                                   ...
                                   <TouchableOpacity onPress={() => navigate('Notification')} style={{width:40,height:40,backgroundColor:'#ffff',borderRadius:40,justifyContent:'center',alignItems:'center'}}>
                                    <Image source={NotificationIcon} alt="icon" style={{height: 15, width: 15, resizeMode: 'contain'}} />
                                    </TouchableOpacity>
                            </View>
